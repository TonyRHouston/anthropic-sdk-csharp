...
public sealed record class BetaRawMessageStartEvent : ModelBase, IFromRaw<BetaRawMessageStartEvent>
{
    ...
    public BetaRawMessageStartEvent(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaRawMessageStartEvent(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
