...
public sealed record class BetaCitationPageLocation : ModelBase, IFromRaw<BetaCitationPageLocation>
{
    ...
    public BetaCitationPageLocation(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaCitationPageLocation(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
