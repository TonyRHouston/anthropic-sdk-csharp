        ...
        IFromRaw<BetaCitationCharLocationParam>
{
    ...
    public BetaCitationCharLocationParam(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaCitationCharLocationParam(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
