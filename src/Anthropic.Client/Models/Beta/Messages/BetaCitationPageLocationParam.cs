        ...
        IFromRaw<BetaCitationPageLocationParam>
{
    ...
    public BetaCitationPageLocationParam(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaCitationPageLocationParam(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
