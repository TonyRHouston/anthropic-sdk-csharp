        ...
        IFromRaw<BetaCitationsWebSearchResultLocation>
{
    ...
    public BetaCitationsWebSearchResultLocation(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BetaCitationsWebSearchResultLocation(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
