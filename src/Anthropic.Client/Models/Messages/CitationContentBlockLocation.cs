        ...
        IFromRaw<CitationContentBlockLocation>
{
    ...
    public CitationContentBlockLocation(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CitationContentBlockLocation(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
