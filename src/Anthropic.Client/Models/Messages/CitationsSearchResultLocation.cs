        ...
        IFromRaw<CitationsSearchResultLocation>
{
    ...
    public CitationsSearchResultLocation(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CitationsSearchResultLocation(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
