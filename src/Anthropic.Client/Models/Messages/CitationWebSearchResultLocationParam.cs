        ...
        IFromRaw<CitationWebSearchResultLocationParam>
{
    ...
    public CitationWebSearchResultLocationParam(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CitationWebSearchResultLocationParam(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
