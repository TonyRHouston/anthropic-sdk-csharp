        ...
        IFromRaw<CitationSearchResultLocationParam>
{
    ...
    public CitationSearchResultLocationParam(IReadOnlyDictionary<string, JsonElement> properties)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CitationSearchResultLocationParam(FrozenDictionary<string, JsonElement> properties)
    {
        this._properties = [.. properties];
    }
